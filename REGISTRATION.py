...
firstw=Tk()
firstw.title("ASHOKA CENTER OF BUSINESS AND COMPUTER STUDIES")
firstw.geometry("1600x1000+0+0")
label=Label(text="ASHOKA CENTER OF BUSINESS AND COMPUTER STUDIES",font=("times new roman",35),bg="skyblue")
...
def second():
    global secondw
    secondw=Tk()
    secondw.title("ASHOKA CENTER OF BUSINESS AND COMPUTER STUDIES")
    ...
    def studentid():
        ...
        mainlabel = Label(rot, text="ENQUIRY DETAILS", font=("times new roman", 35), bg="pink")
        ...
        ttk.Style().configure("Treeview", background="yellow", foreground="coral1")
        ttk.Style().configure("Treeview.Heading", background="orange", foreground="Pink")
    ...
    def viewenquiry2():
        ...
        mainlabel =Label(rt, text="VISITOR", font=("times new roman", 35), bg="green")
        mainlabel.pack(side=TOP, fill=X)
        ...
        ttk.Style().configure("Treeview.heading", background="blue", foreground="purple")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="ASHOKA CENTER OF BUSINESS AND COMPUTER STUDIES", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
    button = Button(secondw,width=15, font=("arial", 20), text="REGISTRATION", bg="Skyblue", command=distroy4)
    button.place(x=10, y=480)
    enquiry = Button(secondw, width=15, font=("arial", 20), text="FEE DETAILS", bg="Skyblue",command=distroy5)
    enquiry.place(x=280, y=480)
    fee_details = Button(secondw, width=15, font=("arial", 20), text="ENQUIRY", bg="Skyblue",command=enquiry1)
    fee_details.place(x=560, y=480)
    viewenquiry= Button(secondw, width=15, font=("arial", 20), text="VIEW ENQUIRY", bg="Skyblue",command=viewenquiry2)
    viewenquiry.place(x=840, y=480)
    viewenquiry1 = Button(secondw, width=15, font=("arial", 20), text="student id ", bg="Skyblue",command=studentid)
...
def root():
    ...
    root.title("ASHOKA CENTER OF BUSINESS AND COMPUTER STUDIES")
    global entry1
    global entry2
    global entry3
    global entry4
    ...
    calculation2 = 2000
    label=Label(root,text="REGISTRATION FORM", font=("arial",25), bg="purple")
    label.pack(side=TOP, fill=X)
...
#=========================buttton==========================
    ...
    button1=Button(root,text="CALCULATE FEE",width=14,font=("arial",10),bg="purple" ,command=calculation)
    button1.place(x=530 , y=590)

    button12 = Button(root, text="BACK", width=17, font=("arial", 17), bg="purple",command=dis )
    button12.place(x=0, y=0)

    button2=Button(root,text="SUBMIT FORM",width=14,font=("arial",10),bg="purple",command= msg  )
    button2.place(x=660 , y=590)

    button3=Button(root,text="RESET",width=14,font=("arial",10),bg="purple",command= golu )
    button3.place(x=395 , y=590)

    button4=Button(root,text="SEARCH",width=14,font=("arial",10),bg="purple" ,command=all )
    ...
    button4=Button(root,text="UPDATE",width=14,font=("arial",10),bg="purple" ,command=update)
    button4.place(x=950 , y=590)

    button5=Button(root,text="DELETE",width=14,font=("arial",10),bg="purple",command=delete )
    button5.place(x=800 , y=590)
...
def enquiry1():
    ...
    def enquiry1destroy():
        enquiry1.destroy()
        second()
    label22 = Label(enquiry1, text="ENQUIRY", font=("arial", 25), bg="orange")
    ...
    button = Button(enquiry1, text="submit", width=30, bg="pink", command=r)
    button.place(x=500, y=320)
    button1=Button(enquiry1, text="<< BACK", width=30, bg="pink",command=enquiry1destroy)
